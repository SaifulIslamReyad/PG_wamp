...
-- Tablets & Capsules (Formatted as: Tablet. X (Y mg))
('Tablet. Amoxicillin (250mg)'), 
('Tablet. Amoxicillin (500mg)'), 
('Tablet. Ibuprofen (200mg)'), 
...
('Tablet. Montelukast (10mg)'), 
('Tablet. Levocetirizine (5mg)'), 
('Tablet. Domperidone (10mg)'), 
('Tablet. Pantoprazole (40mg)'), 
('Tablet. Amlodipine (5mg)'), 
('Tablet. Amlodipine (10mg)'), 
('Tablet. Losartan (50mg)'), 
('Tablet. Metformin (500mg)'), 
('Tablet. Metformin (850mg)'), 
('Tablet. Aspirin (75mg)'), 
('Tablet. Aspirin (150mg)'), 

-- Syrups (Formatted as: Syrup. X (Y mg/Z ml))
('Syrup. Paracetamol (120mg/5ml)'), 
('Syrup. Cetirizine (1mg/ml)'), 
('Syrup. Amoxicillin (125mg/5ml)'), 
('Syrup. Amoxicillin (250mg/5ml)'), 
('Syrup. Ibuprofen (100mg/5ml)'), 
('Syrup. Dextromethorphan (15mg/5ml)'), 
('Syrup. Ambroxol (15mg/5ml)'), 
('Syrup. Salbutamol (2mg/5ml)'), 
('Syrup. Ranitidine (75mg/5ml)'), 
('Syrup. Erythromycin (200mg/5ml)'), 
('Syrup. Azithromycin (200mg/5ml)');
